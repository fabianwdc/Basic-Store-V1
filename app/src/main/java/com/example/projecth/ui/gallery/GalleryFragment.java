package com.example.projecth.ui.gallery;
...
import com.example.projecth.ServicesCActivity;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mPeopleRV = (RecyclerView) root.findViewById(R.id.myRecycleView3);

        DatabaseReference personsRef = FirebaseDatabase.getInstance().getReference().child("Service");
            ...
            protected void onBindViewHolder(ItemActivity.ItemViewHolder holder, final int position, final Item model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final String iid1 = model.getIid();
...
//                        Intent intent = new Intent(getApplicationContext(), ItemWebView.class);
                        Intent intent = new Intent(getContext(), ServicesCActivity.class);
                        intent.putExtra("id", url);
                        intent.putExtra("prodtitle",nameof);
                        intent.putExtra("imgurl",imgurl);
                        intent.putExtra("desc",descprod);
                        intent.putExtra("iid",iid1);
